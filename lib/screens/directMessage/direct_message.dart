...
// -------------
  ...
  Future<void> loadMessages() async {
    ...
    try {
      ...
      setState(() {
        ...
        tDirectMessages?.forEach((tDirectMessage) {
          if (tDirectMessage.draftMessageStatus == true &&
              tDirectMessage.sendUserId == currentUserId) {
            insertEditText(tDirectMessage.directmsg);
          }
        });
      });
    } catch (e) {
  ...
  Future<void> sendMessage(htmlContent, draftStatus) async {
    if (htmlContent.startsWith("<br/>")) {
      htmlContent = htmlContent.replaceAll("<br/>", " ");
    }
    try {
      await directMessageService.sendDirectMessage(
          widget.userId, htmlContent.trimRight(), files, draftStatus);
      tDirectMessages?.forEach((tDirectMessage) {
        if (tDirectMessage.draftMessageStatus == true &&
            tDirectMessage.sendUserId == currentUserId) {
          directMessageService.deleteMsg(tDirectMessage.id!);
        }
      });
      files.clear();
    } catch (e) {
          ...
          onPressed: () {
            ...
            if (textFieldContent.isNotEmpty) {
              tDirectMessages?.forEach((tDirectMessage) {
                if (tDirectMessage.draftMessageStatus == true &&
                    tDirectMessage.sendUserId == currentUserId) {
                  draftedMessageId = tDirectMessage.id;
                }
              });
              if (draftedMessageId == null) {
                ...
                draftStatus = true;
                sendMessage(htmlContent, draftStatus);
              } else {
                htmlContent = detectStyles();
                if (htmlContent.contains("<p>")) {
                  htmlContent = htmlContent.replaceAll("<p>", "");
                ...
                directMessageService.editDirectMessge(
                    htmlContent, draftedMessageId!);
              }
            } else {
              tDirectMessages?.forEach((tDirectMessage) {
                if (tDirectMessage.draftMessageStatus == true &&
                  ...
                  children: [
                    Expanded(
                      ...
                      itemBuilder: (context, index) {
                        int? send_user_id =
                            tDirectMessages![index].send_user_id;
                        bool? draftMessageStatus =
                            tDirectMessages![index].draftMessageStatus;
                        ...
                        String filterMsg =
                            channelStar[index].directmsg.toString();
                                                                      ...
                                                                      "ol": flutter_html
                                                                        ...
                                                                        margin: flutter_html.Margins.symmetric(
                                                                            horizontal:
                                                                                10),
                                                                        padding:
                                                                            flutter_html.HtmlPaddings.symmetric(horizontal: 10),
                                                                      ),
                                                                      "ul": flutter_html
                                                                          .Style(
                                                                        display: flutter_html
                                                                          ...
                                                                          children: [
                                                                            TextButton.icon(
                                                                              ...
                                                                              onPressed: () async {
                                                                                ...
                                                                                if (directMsgIds != null) {
                                                                                  if (isStared) {
                                                                                    await directMessageService.directUnStarMsg(directMsgIds);
                                                                                  } else {
                                                                                    await directMessageService.directStarMsg(widget.userId, directMsgIds);
                                                                                  }
                                                                                }
                                                                              },
                                                                            ),
                                                                                ...
                                                                                final value = await Navigator.push(
                                                                                    ...
                                                                                    MaterialPageRoute(
                                                                                        builder: (_) => DirectMessageThreadWidget(
                                                                                              userstatus: currentUserActiveStatus,
                                                                                              receiverId: widget.userId,
                                                                                              directMsgId: directMsgIds,
                                                                                    ...
                                                                                    builder: (BuildContext context) {
                                                                                      return EmojiPicker(
                                                                                        onEmojiSelected: (category, Emoji emoji) {
                                                                                          ...
                                                                                          directMessageService.directReactMsg(selectedEmoji, directMsgIds, widget.userId, currentUserId, 1);
                                                                            ...
                                                                            TextButton.icon(
                                                                              ...
                                                                              onPressed: () async {
                                                                                if (directMsgIds != null) {
                                                                                  await directMessageService.deleteMsg(directMsgIds);
                                                                                }
                                                                                Navigator.pop(context);
                                                                              },
                                                                  ...
                                                                  style:
                                                                    ...
                                                                    padding: WidgetStateProperty.all(
                                                                        EdgeInsets
                                                                            .zero),
                                                                    minimumSize:
                                                                        WidgetStateProperty.all(const Size(
                                                                            50,
                                                                            25)),
                                                                  ),
                                                                  child: Text(
