              ...
              child: Container(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    int count1 = SessionStore
                        .sessionData!.directMsgcounts![index]
                        .toInt();
                    int userIds =
                        SessionStore.sessionData!.mUsers![index].id!.toInt();
                    String userName = SessionStore
                        .sessionData!.mUsers![index].name
                        .toString();
                    return Padding(
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => DirectMessageWidget(
                                ...
                                receiverName: directMessageUserName!,
                              ),
                            ),
                          );
                        },
