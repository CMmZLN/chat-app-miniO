...
class _UnReadGroupThreadState extends State<UnReadGroupThread> {
  ...
  Widget build(BuildContext context) {
    List filterMessages = snapshot!.unreadGpThreads!
        ...
        body: LiquidPullToRefresh(
          ...
          child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                final groupThreadId = filterMessages[index].id;
                ...
                String filterMsg =
                    filterMessages[index].groupthreadmsg.toString();
                String groupThreadMessage = filterMsg;
