...
class _UnReadDirectMsgState extends State<UnReadDirectMsg> {
  ...
  Widget build(BuildContext context) {
    List filterMessages = snapshot!.unreadDirectMsg!
          ...
          child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                String directMessageName =
                    filterMessages[index].name.toString();
                ...
                String filterMsg = filterMessages[index].directmsg.toString();
                String directMessage = filterMsg;

                int unreadDirectMsgId = filterMessages[index].id!.toInt();
