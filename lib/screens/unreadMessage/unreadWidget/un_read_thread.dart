...
class _UnReadDirectThreadState extends State<UnReadDirectThread> {
  ...
  List<Un_Thread>? unreadDirectThreadMsg;
  ...
  Future<void> _fetchData() async {
    ...
    try {
      ...
      setState(() {
        ...
        tDirectThreadMsgEmojiCounts = unreadListStore.tDirectThreadEmojiCounts!;
        tDirectReactThreadMsgIds = unreadListStore.tDirectReactThreadMsgIds!;
        reactUsernamesForDirectThread =
            unreadListStore.reactUsernamesForDirectThread!;
      });
    } catch (e) {
      rethrow;
    }
  ...
  Widget build(BuildContext context) {
    List filterMessages = snapshot!.unreadThreads!
        .where((data) => data.draftStatus != true || data.draftStatus != null)
        .toList();
    return Scaffold(
        ...
        body: LiquidPullToRefresh(
          ...
          child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                int unreadDirectThreadMsgId = filterMessages[index].id!.toInt();
                String directThreadName = filterMessages[index].name.toString();
                ...
                String filterMsg =
                    filterMessages[index].directthreadmsg.toString();

                String directMessage = filterMsg;

                String directMessageTime =
                    filterMessages[index].created_at.toString();
