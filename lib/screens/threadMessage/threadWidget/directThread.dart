        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            if (snapshot!.directMsg!.isEmpty) {
              ...
              String directMessageTagFilter =
                  directMessageList[index].directmsg.toString();

              String dmMessage = directMessageTagFilter;
              ...
              List filterMessages = directThreadList
                  .where((thread) =>
                      thread.draftStatus == false || thread.draftStatus == null)
                  .toList();
              ...
              int threadLastLength = filterMessages.length <= 2
                  ? filterMessages.length
                  : (filterMessages.length + 3) - filterMessages.length;

              int leftMessageLength = filterMessages.length - threadLastLength;
                                ...
                                children: [
                                  ...
                                  ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      threadFileName =
                                          filterMessage[index].fileNames;

                                      String? threadProfileName =
                                          filterMessage[index].profileImage;
