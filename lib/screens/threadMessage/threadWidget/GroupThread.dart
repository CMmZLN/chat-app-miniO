      ...
      body: LiquidPullToRefresh(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            String groupMessageTagFilter =
                directGroupList[index].groupmsg!.toString();

            String groupMessage = groupMessageTagFilter;
            ...
            List filterMessages = groupMessageThreadList
                .where((thread) =>
                    thread.draftStatus != true || thread.draftStatus == null)
                .toList();

            int lastThreeindex =
                filterMessages.length >= 3 ? filterMessages.length - 3 : 0;

            List filterMessage = filterMessages.sublist(lastThreeindex);

            int groupThreadLastLength = filterMessages.length <= 2
                ? filterMessages.length
                : (filterMessages.length + 3) - filterMessages.length;

            int leftMessageLength =
                filterMessages.length - groupThreadLastLength;
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    String threadMessageFilter =
                                        filterMessage[index]
                                            .groupthreadmsg
                                            .toString();
                                    String message = threadMessageFilter;

                                    int messageId =
                                        filterMessage[index].id.toInt();
                                    String senderName =
                                        filterMessage[index].name.toString();

                                    String dateTime = filterMessage[index]
                                        .created_at
                                        .toString();
                                    ...
                                    threadFiles = filterMessage[index]
                                        .fileUrls
                                    ...
                                    threadFileName =
                                        filterMessage[index].fileName;

                                    String? groupThreadProfileName =
                                        filterMessage[index].profileName;
                                      ...
                                      children: [
                                        ...
                                        SizedBox(
                                          ...
                                          child: Wrap(
                                            ...
                                            spacing: 7,
                                            children: List.generate(
                                                tGroupThreadEmojiCounts!.length,
                                                (index) {
                                              List userIds = [];
                                              List reactUsernames = [];
                                              if (tGroupThreadEmojiCounts![
                                                          index]
                                                      .groupThreadId ==
                                                  messageId) {
                                                for (dynamic reactUser
