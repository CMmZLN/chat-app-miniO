...
class DirectMessageService {
  ...
  Future<void> sendDirectMessage(int receiverUserId, String message,
      List<PlatformFile>? files, bool draftStatus) async {
  ...
  Future<void> sendDirectMessageThread(int directMsgId, int receiveUserId,
      String message, List<PlatformFile>? files, bool draftStatus) async {
    int currentUserId = SessionStore.sessionData!.currentUser!.id!.toInt();
    Map<String, dynamic> requestBody = {
  ...
  Future<void> directReactMsg(String emoji, int msgId, int selectedUserId,
