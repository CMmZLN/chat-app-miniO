...
class _DirectMsgThreadService implements DirectMsgThreadService {
  ...
  Future<DirectMessageThread> getAllThread(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'http://10.0.2.2:3000/directhread/${directMsgid}',
  ...
  Future<String> sentThread(
    ...
    final _result = await _dio.fetch<String>(_setStreamType<String>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'http://10.0.2.2:3000/directthreadmsg',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<void> unStarThread(
    ...
    await _dio.fetch<void>(_setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'http://10.0.2.2:3000/unstarthread',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<void> deleteThread(
    ...
    await _dio.fetch<void>(_setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'http://10.0.2.2:3000/delete_directthread',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  @override
  Future<void> editdirectThreadMessage(
    Map<String, dynamic> requestBody,
    String token,
  ) async {
    final _extra = <String, dynamic>{};
    ...
    await _dio.fetch<void>(_setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'http://10.0.2.2:3000/update_directthreadmsg',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<void> directThreadMessageReaction(
    ...
    await _dio.fetch<void>(_setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'http://10.0.2.2:3000/directthreadreact',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
