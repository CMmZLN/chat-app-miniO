  ...
  Future<DirectMessages> getAllDirectMessages(
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'http://10.0.2.2:3000/m_users/${userId}',
  ...
  Future<void> deleteMessage(
    ...
    await _dio.fetch<void>(_setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'http://10.0.2.2:3000/delete_directmsg',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<void> directReactMsg(
    ...
    await _dio.fetch<void>(_setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'http://10.0.2.2:3000/directreact',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<void> editdirectMessage(
    ...
    await _dio.fetch<void>(_setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'http://10.0.2.2:3000/update_directmsg',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
