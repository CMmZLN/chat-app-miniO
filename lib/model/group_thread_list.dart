class GroupThreadMessage {
  ...
  GroupThreadMessage(
      ...
      this.emojiCounts,
      this.reactUserDatas,
      this.GroupEmojiCounts,
      this.GroupReactUserDatas});
  ...
  GroupThreadMessage.fromJson(Map<String, dynamic> json) {
    ...
    if (json['retrieveGroupThread']['group_emoji_counts'] != null) {
      GroupEmojiCounts = <EmojiCountsforGpMessage>[];
      json['retrieveGroupThread']['group_emoji_counts'].forEach((v) {
        GroupEmojiCounts!.add(EmojiCountsforGpMessage.fromJson(v));
      });
    }
    if (json['retrieveGroupThread']['group_react_usernames'] != null) {
      GroupReactUserDatas = <ReactUserDataForGpMessage>[];
      json['retrieveGroupThread']['group_react_usernames'].forEach((v) {
        GroupReactUserDatas!.add(ReactUserDataForGpMessage.fromJson(v));
      });
    }
  }
...
class ReactUserDataForGpMessage {
  String? name;
  int? groupMessageId;
  String? emoji;
  int? userId;

  ReactUserDataForGpMessage(
      {this.name, this.groupMessageId, this.emoji, this.userId});

  ReactUserDataForGpMessage.fromJson(Map<String, dynamic> json) {
    name = json['name'];
    groupMessageId = json['groupmsgid'];
    emoji = json['emoji'];
    userId = json['userid'];
  }
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = <String, dynamic>{};
    data['name'] = name;
    data['groupmsgid'] = groupMessageId;
    data['emoji'] = emoji;
    data['userid'] = userId;
    return data;
  }
...
class EmojiCountsforGpMessage {
  int? groupMessageId;
  String? groupEmoji;
  int? groupEmojiCount;

  EmojiCountsforGpMessage(
      {this.groupMessageId, this.groupEmoji, this.groupEmojiCount});

  EmojiCountsforGpMessage.fromJson(Map<String, dynamic> json) {
    groupMessageId = json['groupmsgid'];
    groupEmoji = json['emoji'];
    groupEmojiCount = json['emoji_count'];
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = <String, dynamic>{};
    data['groupmsgid'] = groupMessageId;
    data['emoji'] = groupEmoji;
    data['emoji_count'] = groupEmojiCount;
    return data;
  }
}
